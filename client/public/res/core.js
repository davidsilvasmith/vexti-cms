...
define([
    ...
    var checkPayment = _.debounce(function() {
        ...
        console.log('checkpayment: monetize was removed');
        removeAlerts();
    ...
    eventMgr.addListener("onReady", function() {
        ...
        $(".action-insert-local-image").click(function(e) {
            console.log('waiting for upload...');
            setTimeout(
                function() {
                	var iPath = document.getElementById("imageInsertPath").innerHTML;
                    console.log('image path: ');
                    //var value = utils.getInputValue($("#imageInsertPath"));
                    console.log(iPath);
                    if (iPath !== undefined) {
                        core.insertLinkCallback(iPath);
                        core.insertLinkCallback = undefined;
                    }
                }, 5000);
        });
